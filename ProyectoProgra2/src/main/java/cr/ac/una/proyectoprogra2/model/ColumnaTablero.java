...
public class ColumnaTablero implements Serializable {
    ...
    @Id
    @SequenceGenerator(name = "COLUMNA_TABLERO_ID_GENERATOR", sequenceName = "una.COLUMNA_TABLERO_SEQ01", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "COLUMNA_TABLERO_ID_GENERATOR")
    ...
    public String toString() {
        return "cr.ac.una.proyectoprogra2.model.ColumnaTablero[ idColumnaTablero=" + id + " ]";
    }
