...
public class Carta implements Serializable {
    ...
    @Id
    @SequenceGenerator(name = "CARTA_ID_GENERATOR", sequenceName = "una.CARTA_SEQ01", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "CARTA_ID_GENERATOR")
